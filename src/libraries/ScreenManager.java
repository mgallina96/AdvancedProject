...
public class ScreenManager 
{
	 ...
	 * Two display modes match if they have the same resolution, bit depth, and refresh rate.
	 * The bit depth is ignored if one of the modes has a bit depth of DisplayMode.BIT_DEPTH_MULTI.
	 ...
	 * If the specified display mode is null or not compatible with this device, or if the display mode cannot be
	 ...
	 * The ScreenManager uses double buffering, so applications must call update() to show any graphics drawn.
	 * <p>
